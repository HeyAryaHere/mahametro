...
import sys
sys.path.append('.\Model_files\crowd_counting')
from model_crowd import CSRNet
import torch
...
model = CSRNet()
checpoint = torch.load('.\Model_files\crowd_counting\weights.pth', map_location='cpu')
...
def generate_frames():
    video_path = "data\Crowding Near Ticketing line_1.avi"
